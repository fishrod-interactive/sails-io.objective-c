#
#  Be sure to run `pod spec lint Sails.IO.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.authors          = { "Gavin Williams" => "gavin.williams@fishrod.co.uk", "other author" => "email@address.com" }
  # s.author           = 'Gavin Williams', 'other author'
  ...
  s.source       = { :git => "https://github.com/fishrod-interactive/sails-io.objective-c.git", :tag => "0.0.1" }
